document.addEventListener("DOMContentLoaded", function() {
    ...
    function createPlayerInputs(count) {
        ...
        for (let i = 0; i < count; i++) {
            ...
            playerDiv.innerHTML = `<p>${playerName} (Kokonaispisteet: 0, kierroksen pisteet: 0)</p><img />`;
    ...
    function updateCurrentPlayerScoreDisplay(endTurn = false) {
        ...
        playerScoreText.textContent = `${playerScoreText.textContent.split(" (")[0]} (pisteet: ${playerScores[currentPlayer]}, kierroksen pisteet: ${endTurn ? '0' : roundScore})`;
    }
    ...
    function checkForWin() {
        if (playerScores[currentPlayer] + roundScore >= 100) {
